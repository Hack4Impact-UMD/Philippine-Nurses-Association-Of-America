...
const Fundraising = () => {
  ...
  const columns = [
    ...
    { 
      ...
      width: 150, 
      renderCell: (params) => ( 
        <Status text="03.04.2018" textColor="black" width="150px" height="20px"/> 
      ) 
    },
    { 
      field: 'Type', 
      ...
      width: 150, 
      renderCell: (params) => ( 
        <Status text="Event" backgroundColor={"#EBF0FA"} textColor="blue" width="150px" height="20px"/> 
      ) 
    },
    { 
      field: 'Amount', 
      ...
      width: 150, 
      renderCell: (params) => ( 
        <Status text="$1000.00" textColor="black" width="150px" height="20px"/> 
      ) 
    },
    { 
      field: 'Status', 
      ...
      width: 150, 
      renderCell: (params) => ( 
        <Status text="Completed" backgroundColor={"#E1FCEF"} textColor="green" width="150px" height="20px"/> 
      ) 
    },
    { 
      field: 'Note', 
      ...
      width: 150, 
      renderCell: (params) => ( 
        <Status text="Additional Note" textColor="black" width="150px" height="20px"/> 
      ) 
    }
  ];
